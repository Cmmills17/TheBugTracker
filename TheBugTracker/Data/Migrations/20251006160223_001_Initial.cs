        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IviteeEmail = table.Column<string>(type: "text", nullable: false),
                    IviteeFirstName = table.Column<string>(type: "text", nullable: false),
                    IviteeLastName = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attatchments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attatchments_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attatchments_Uploads_UploadId",
                        column: x => x.UploadId,
                        principalTable: "Uploads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attatchments_TicketId",
                table: "Attatchments",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_Attatchments_UploadId",
                table: "Attatchments",
                column: "UploadId");

            migrationBuilder.CreateIndex(
                name: "IX_Attatchments_UserId",
                table: "Attatchments",
                column: "UserId");
